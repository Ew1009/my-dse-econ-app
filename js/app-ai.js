...
function showAiSettings(){
  ...
  h+='<div style="line-height:1.5">This app uses OpenRouter API with the <strong>Arcee Trinity Large Preview</strong> model (free tier). Your API key is securely stored in Vercel Environment Variables and never exposed to the browser.</div>';
  h+='<ul style="margin:8px 0 0 20px;line-height:1.8">';
  h+='<li>Model: <strong>arcee-ai/arcee-trinity-large-preview:free</strong></li>';
