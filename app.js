...
/**
 * Load questions - using embedded data
 */
async function loadQuestions() {
  try {
    ...
    const questionData = {
      mcq: [
        { id: 'q1', topic: 'micro-1', question: 'A good is a free good if', options: ['it is not rare or it can be found easily.', 'there is enough of it available free of charge for everyone who wants it.', 'there is enough of it available for everybody who pays the market price for it.', 'no one owns it.'], answer: 1, explanation: 'A free good has enough availability at zero price for all who want it.' },
        { id: 'm2', topic: 'micro-1', question: 'The Production Possibilities Curve (PPC) shows:', options: ['Maximum profit combinations', 'Maximum output combinations with given resources', 'All possible prices', 'Consumer preferences'], answer: 1, explanation: 'The PPC illustrates maximum output combinations producible with given resources.' },
        { id: 'm3', topic: 'micro-1', question: 'Which statement about economic goods is correct?', options: ['Always tangible', 'Free of charge', 'Scarce relative to wants', 'No opportunity cost'], answer: 2, explanation: 'Economic goods are scarce relative to wants.' },
        { id: 'm4', topic: 'micro-3', question: 'Price rises from $10 to $12, Qd falls 100 to 80. PED is:', options: ['-0.5', '-1.0', '-1.5', '-2.0'], answer: 1, explanation: 'PED = (-20%/20%) = -1.0' },
        { id: 'm5', topic: 'micro-3', question: 'XED between A and B is +2.5. The goods are:', options: ['Complements', 'Substitutes', 'Unrelated', 'Inferior'], answer: 1, explanation: 'Positive XED = substitute goods.' },
        { id: 'm6', topic: 'micro-3', question: 'Price ceiling below equilibrium results in:', options: ['Surplus', 'Shortage', 'No change', 'Higher price'], answer: 1, explanation: 'Binding price ceiling creates shortage (Qd > Qs).' },
        { id: 'm7', topic: 'micro-3', question: 'Law of demand states, ceteris paribus:', options: ['Income up then demand up', 'Price down then Qd up', 'Supply up then price down', 'Tech up then cost down'], answer: 1, explanation: 'Inverse relationship between price and quantity demanded.' },
        { id: 'm8', topic: 'micro-3', question: 'Leftward shift of supply could be caused by:', options: ['Better technology', 'Lower input costs', 'Higher input costs', 'More firms'], answer: 2, explanation: 'Higher input costs reduce supply.' },
        { id: 'm9', topic: 'micro-4', question: 'In perfect competition, firms are price takers because:', options: ['Gov sets prices', 'Each firm output is negligible', 'Barriers to entry', 'Differentiated products'], answer: 1, explanation: 'Each firm is too small to influence market price.' },
        { id: 'm10', topic: 'micro-4', question: 'Monopolist earns LR profits because:', options: ['Elastic demand', 'No barriers', 'Significant barriers to entry', 'Min AC production'], answer: 2, explanation: 'Barriers prevent entry, sustaining profits.' }
      ]
    };
